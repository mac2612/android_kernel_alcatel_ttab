...
UINT32 GC2375MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(GC2235_MIPI)
    {GC2235MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2235_MIPI, GC2235MIPISensorInit},
#endif
#if defined(GC2375_MIPI_RAW)
    {GC2375MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2375_MIPI_RAW, GC2375MIPISensorInit},
#endif
